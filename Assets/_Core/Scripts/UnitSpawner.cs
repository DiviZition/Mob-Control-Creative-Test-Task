...
public class UnitSpawner : IUpdatable, IDisposable
{
    ...
    private void CreateNewUnit()
    {
        ...
        IUnitMovement unitMovement = new UnitNavMeshMovement(unitView.Agent, unitView.Transform, _unitConfig.MoveSpeed);

        UnitBase unitBase = new UnitBase(unitView, this, unitHealth, unitMovement);
