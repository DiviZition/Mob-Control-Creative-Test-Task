...
public class UnitAttacker : IUnitAttack
{
    ...
    private void GetStunnedAfterAttack()
    {
        _timer = _unitConfig.AttackStunDuration;
        _state = AttackState.Stunned;
    }
    ...
    {
        _timer = _unitConfig.AttackWindUpDuration;
